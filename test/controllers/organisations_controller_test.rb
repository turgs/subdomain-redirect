...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference("Organisation.count") do
      post organisations_url, params: { organisation: { creator: @organisation.creator, name: @organisation.name, subdomain: @organisation.subdomain } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { creator: @organisation.creator, name: @organisation.name, subdomain: @organisation.subdomain } }
